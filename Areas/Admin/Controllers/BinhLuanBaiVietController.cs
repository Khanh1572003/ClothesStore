...
namespace ClothesShoping.Areas.Admin.Controllers
{
    ...
    public class BinhLuanBaiVietController : Controller
    {
        ...
        public BinhLuanBaiVietController(ClothesShopingDbContext context, IHttpContextAccessor httpContextAccessor)
        {
            _context = context;
        ...
        {
            var clothesShopingDbContext = _context.BinhLuanBaiViet.Include(b => b.BaiViet).Include(b => b.NguoiDung).OrderByDescending(r => r.NgayDang);
