...
namespace ClothesShoping.Areas.Admin.Controllers
{
    ...
    public class BaiVietController : Controller
    {
        ...
        public BaiVietController(ClothesShopingDbContext context, IHttpContextAccessor httpContextAccessor)
        {
            _context = context;
        ...
        {
            var clothesShopingDbContext = _context.BaiViet.Include(b => b.ChuDe).Include(b => b.NguoiDung).OrderByDescending(r => r.NgayDang);
