...
namespace ClothesShoping.Areas.Admin.Controllers
{
	...
	public class SanPhamController : Controller
    {
        ...
        public SanPhamController(ClothesShopingDbContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        {
            //var clothesShopingDbContext = _context.SanPham.Include(s => s.HangSanXuat).Include(s => s.LoaiSanPham);
